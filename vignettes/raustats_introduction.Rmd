...
subset of all ABS statistics. This package also provides a reasonably
comprehensive range of functions to search and download data from the
[ABS.Stat](http://stat.data.abs.gov.au/) API. Please note that as the
API is currently in development, changes in the API backend may break
the functions provided in this package.
...
RBA statistics. First, load the library:
